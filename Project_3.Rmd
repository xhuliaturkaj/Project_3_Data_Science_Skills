...
combined_text <- paste(text_for_program_1, text_for_program_2, text_for_program_3,text_for_program_4,text_for_program_5, text_for_program_6, text_for_program_7, text_for_program_8, text_for_program_9, text_for_program_10, collapse = " ", show_col_types = FALSE)
...
# element_detect <- lapply(searchTerms, function(y) str_extract_all(scraped_skills_table, y))
# element_count <- lapply(element_detect, function(x) length(x[[1]]))
# element_count_table <- as_tibble(do.call(rbind, lapply(element_count, function(x) c(Count = x))))
